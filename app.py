...
def show_venue(venue_id):
    ...
    av_venue = db.session.query(Venue).get(venue_id)
    ...
    data = {
        "id": av_venue.id,
        "name": av_venue.name,
        "genres": av_venue.genres,
        "city": av_venue.city,
        'Address': av_venue.address,
        "state": av_venue.state,
        "phone": av_venue.phone,
        "website_link": av_venue.website_link,
        "facebook_link": av_venue.facebook_link,
        "seeking_talent": av_venue.seeking_talent,
        "seeking_description": av_venue.seeking_description,
        "image_link": av_venue.image_link,
